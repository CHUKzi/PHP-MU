...
if [ "$choice" == "1" ]; then
    ...
    sudo apt install -y \
    php7.4 php7.4-fpm php7.4-mysql php7.4-mbstring php7.4-dom php7.4-xml php7.4-curl php7.4-zip php7.4-bcmath php7.4-intl php7.4-soap php7.4-gd php7.4-imagick \
    php8.1 php8.1-fpm php8.1-mysql php8.1-mbstring php8.1-dom php8.1-xml php8.1-curl php8.1-zip php8.1-bcmath php8.1-intl php8.1-soap php8.1-gd php8.1-imagick \
    ...
    echo ""
    echo "=================================================================="
    echo "Server setup is complete! PHP 7.4, 8.1, 8.2, and 8.3 have been installed."
    echo "=================================================================="
else
